...
picture = 'https://picua.org/images/2019/01/09/6d6927e1747bd593243ddb63b9bc851b.png'
...
# При отсутствии запроса ( = пустой запрос) выводим некоторую информацию
@bot.inline_handler(lambda query: len(query.query) is 1)
def empty_query(query):
    hint = "Введите еще 1 число и получите результат!"
    try:
        r = types.InlineQueryResultArticle(
            id='1',
            title="Бот \"Математика\"",
    ...
    try:
        ...
        if num2 is not "0":
            ...
            r_div = types.InlineQueryResultArticle(
                ...
                input_message_content=types.InputTextMessageContent(
                    message_text="Я нехороший человек и делю на ноль!", disable_web_page_preview=True),
